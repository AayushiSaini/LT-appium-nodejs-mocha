...
var config = {
  commonCapabilities: {
    'lt:options': {
      'build': "Mocha-Android-Native-App",
      'name': 'Parallel-App-Test',
      'isRealMobile': true,
      'w3c': true
    },
  ...
  multiCapabilities: [
    { 'platformName': 'android', 'appium:deviceName': 'Galaxy S21 5G', 'appium:platformVersion': '12' },
    { 'platformName': 'android', 'appium:deviceName': 'Galaxy S20', 'appium:platformVersion': '11' }
  ]
};
